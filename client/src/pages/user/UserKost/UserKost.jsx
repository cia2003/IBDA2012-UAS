...
import style from "./userKost.module.css";
  ...
  return (
    <div>
      <main className={style.homeContainer}>
        ...
        <div
          id="search-section"
          className="w-full max-w-5xl mb-10 mx-auto bg-white rounded-[2.5rem] shadow-2xl shadow-zinc-200/60 p-3 border border-zinc-100 relative z-20"
        >
